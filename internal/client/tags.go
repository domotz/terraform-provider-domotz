...
func (c *Client) GetTag(ctx context.Context, tagID int32) (*Tag, error) {
...
func (c *Client) UpdateTag(ctx context.Context, tagID int32, req UpdateTagRequest) (*Tag, error) {
	path := fmt.Sprintf("/custom-tag/%d", tagID)
	if err := c.doRequestNoContent(ctx, "PUT", path, req); err != nil {
		return nil, fmt.Errorf("failed to update tag: %w", err)
	}

	// Retrieve the updated tag
	return c.GetTag(ctx, tagID)
}

// DeleteTag deletes a tag
func (c *Client) DeleteTag(ctx context.Context, tagID int32) error {
	path := fmt.Sprintf("/custom-tag/%d", tagID)
...
func (c *Client) BindTagToDevice(ctx context.Context, agentID, deviceID, tagID int32) error {
	path := fmt.Sprintf("/agent/%d/device/%d/custom-tag/%d/binding", agentID, deviceID, tagID)
	if err := c.doRequestNoContent(ctx, "POST", path, nil); err != nil {
...
func (c *Client) UnbindTagFromDevice(ctx context.Context, agentID, deviceID, tagID int32) error {
	path := fmt.Sprintf("/agent/%d/device/%d/custom-tag/%d/binding", agentID, deviceID, tagID)
	if err := c.doRequestNoContent(ctx, "DELETE", path, nil); err != nil {
...
func (c *Client) ListDeviceTags(ctx context.Context, agentID, deviceID int32) ([]Tag, error) {
	path := fmt.Sprintf("/agent/%d/device/%d/custom-tag/binding", agentID, deviceID)
	var tags []Tag
	if err := c.doRequest(ctx, "GET", path, nil, &tags); err != nil {
